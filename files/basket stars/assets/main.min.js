...
! function e(t, n, o) {
  ...
  2: [function(e, t, n) {
    (function(o, i) {
      ! function(e, o) {
        ...
        function _(e, t) {
          e._state === Y && (e._result = t, e._state = Q, 0 !== e._subscribers.length && N(w, e))
        }
        ...
        function A(e, t, n, o) {
          var i = e._subscribers,
            r = i.length;
          e._onerror = null, i[r] = t, i[r + Q] = n, i[r + V] = o, 0 === r && e._state && N(w, e)
        }
        ...
        var z = Math.random().toString(36).substring(2),
          ...
          X = function() {
            function e(e, t) {
              this._instanceConstructor = e, this.promise = new e(u), this.promise[z] || R(this.promise), L(t) ? (this.length = t.length, this._remaining = t.length, this._result = new Array(this.length), 0 === this.length ? _(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(t), 0 === this._remaining && _(this.promise, this._result))) : E(this.promise, I())
            }
            return e.prototype._enumerate = function(e) {
              ...
              var o = this.promise;
              o._state === Y && (this._remaining--, e === V ? E(o, n) : this._result[t] = n), 0 === this._remaining && _(o, this._result)
          ...
          Z = function() {
            function e(t) {
              this[z] = C(), this._result = this._state = void 0, this._subscribers = [], u !== t && ("function" != typeof t && x(), this instanceof e ? S(this, t) : k())
            }
    ...
    ! function(e) {
      ...
      function l() {
        return this.bodyUsed = !1, this._initBody = function(e) {
          ...
          else if (b.arrayBuffer && b.blob && y(e)) this._bodyArrayBuffer = u(e.buffer), this._bodyInit = new Blob([this._bodyArrayBuffer]);
          else {
        ...
        m.redirect = function(e, t) {
          ...
          return new Promise(function(n, o) {
            ...
            r.onload = function() {
              ...
              o(new TypeError("Network request failed"))
            }, r.open(i.method, i.url, !0), "include" === i.credentials && (r.withCredentials = !0), "responseType" in r && b.blob && (r.responseType = "blob"), i.headers.forEach(function(e, t) {
  ...
  9: [function(e, t, n) {
    ...
    var r = e("js-base64"),
      s = function() {
        function e(t) {
          o(this, e), this._config = t || {}, this._url = t.url || "https://msgrt.gamedistribution.com/collect"
        }
        return i(e, [{
          key: "send",
          value: function(e, t) {
            ...
            t && t.length > 0 && t.forEach(function(e) {
              return n.push(e)
            }), n = encodeURIComponent(r.Base64.encode(JSON.stringify(n))), fetch(this._url + "?tp=com.gdsdk." + e + "&ar=" + n + "&ts=" + Date.now())
          }
        }]), e
      }();
    n.default = s
        ...
        return i(e, [{
                ...
                try {
                  localStorage.getItem("gd_debug") && localStorage.getItem("gd_tag") ? t(localStorage.getItem("gd_tag")) : e._tunnlReportingKeys().then(function(o) {
                    ...
                    window.idhbgd.que.push(function() {
                      window.idhbgd.setAdserverTargeting(o), window.idhbgd.setDfpAdUnitCode(i), window.idhbgd.setRefererUrl(encodeURIComponent(e.parentUrl)), window.idhbgd.allowPersonalizedAds(s), window.idhbgd.setDefaultGdprConsentString(r), window.idhbgd.requestAds({
                        callback: function(e) {
                          t(e)
                        }
                      })
            ...
            var e = this,
              ...
              n = new Promise(function(t, n) {
                var o = e.options.debug ? "https://test-hb.improvedigital.com/pbw/gameDistribution.min.js?v=1" : "https://hb.improvedigital.com/pbw/gameDistribution.min.js?v=1",
                  i = document.getElementsByTagName("script")[0],
                  r = document.createElement("script");
                r.type = "text/javascript", r.id = "idhbgd", r.async = !0, r.src = o, r.onload = function() {
                  t()
                }, r.onerror = function() {
          ...
          value: function(e, t, n) {
            ...
            d.parentNode.insertBefore(s, d), window.googletag = window.googletag || {}, window.googletag.cmd = window.googletag.cmd || [], googletag.cmd.push(function() {
              var i = [];
              i[0] = googletag.defineSlot("/1015413/Gamedistribution_ingame_1x1_crosspromo", [1, 1], o.prefix + "baguette").setCollapseEmptyDiv(!0, !0).addService(googletag.pubads()), googletag.pubads().setTargeting("crossid", e), googletag.pubads().setTargeting("crosstags", t), googletag.pubads().setTargeting("crosscategory", n), googletag.pubads().disableInitialLoad(), googletag.enableServices(), googletag.display(o.prefix + "baguette"), googletag.pubads().refresh([i[0]])
            })
          }
        }]), e
      }();
  ...
  11: [function(e, t, n) {
    ...
    window.gdApi && "object" === o(window.gdApi.q[0][0]) && window.gdApi.q[0][0] && (r.hasOwnProperty("advertisementSettings") || (r.advertisementSettings = {
      autoplay: !0
    })), window.gdsdk = new i.default(r), window.gdApi = window.gdsdk
  }, {
    "./main": 12
  }],
  12: [function(e, t, n) {
    ...
    var a = o(e("../package.json")),
      ...
      p = function() {
        function e(t) {
          ...
          if (this._analytics(m, p), ["razda.com", "74.127.72.247"].indexOf(p) > -1) return void 0 !== window.ga && window.ga("gd.send", {
            hitType: "event",
          ...
          try {
            ...
            console.log(e)
          }(new Image).src = "https://ana.tunnl.com/event?page_url=" + encodeURIComponent(u) + "&game_id=" + this.options.gameId + "&eventtype=1", this.eventBus = new c.default, this.eventBus.gameId = this.options.gameId + "", this.eventBus.subscribe("SDK_BLOCKED", function(e) {
            return n._onEvent(e)
            ...
            return n._onEvent(e)
          }), this._gdpr(p), this.adRequestTimer = void 0, this.videoAdInstance = new d.default(this.options.flashSettings.adContainerId, this.options.prefix, this.options.advertisementSettings);
          var y = new Promise(function(e) {
            ...
            fetch(i).then(function(e) {
              ...
              if (o.error)(0, h.dankLog)("SDK_GAME_DATA_READY", o.error, "warning");
                ...
                (t = (0, g.extendDefaults)(t, i)).displaySecondPrerollIfFirstOneShort && (n.videoAdInstance.maxPrerollCount = 2), (0, h.dankLog)("SDK_GAME_DATA_READY", t, "success")
              }
              e(t)
            }).catch(function(n) {
        ...
        return s(e, [{
          ...
          value: function(e) {
            var t = document.location.search.indexOf("gdpr-tracking") >= 0,
              ...
              o = "",
              i = "";
            t ? n ? (o = "General Data Protection Regulation is set to allow tracking.", i = "success") : (o = "General Data Protection Regulation is set to disallow tracking.", i = "warning") : (o = "General Data Protection Regulation consent for tracking is not set by the publisher.", i = "warning"), this.eventBus.broadcast("SDK_GDPR_TRACKING", {
          ...
          value: function() {
            var e = this;
            this.videoAdInstance.canRequestPreroll() && (this.videoAdInstance.requestedPrerollCount++, this.videoAdInstance.requestAttempts = 0, this.videoAdInstance.requestAd().then(function(t) {
          ...
          value: function() {
            ...
            this.readyPromise.then(function(t) {
              t.advertisements && !e.whitelabelPartner ? void 0 !== e.adRequestTimer ? (new Date).valueOf() - e.adRequestTimer.valueOf() < t.midroll ? ((0, h.dankLog)("SDK_SHOW_BANNER", "The advertisement was requested too soon after the previous advertisement was finished.", "warning"), e.onResumeGame("Just resume the game...", "success")) : ((0, h.dankLog)("SDK_SHOW_BANNER", "Requested the midroll advertisement.", "success"), e.adRequestTimer = new Date, e.videoAdInstance.requestAttempts = 0, e.videoAdInstance.requestedMidrollCount++, e.videoAdInstance.requestAd().then(function(t) {
                return e.videoAdInstance.loadAd(t)
              }).catch(function(t) {
                e.videoAdInstance.onError(t)
              }), e.msgrt.send("req.ad.midroll." + e.videoAdInstance.requestedMidrollCount)) : ((0, h.dankLog)("SDK_SHOW_BANNER", "Requested the preroll advertisement.", "success"), e.adRequestTimer = new Date, e.videoAdInstance.requestAttempts = 0, e.videoAdInstance.requestedPrerollCount++, e.videoAdInstance.requestAd().then(function(t) {
                return e.videoAdInstance.loadAd(t)
              }).catch(function(t) {
                e.videoAdInstance.onError(t)
